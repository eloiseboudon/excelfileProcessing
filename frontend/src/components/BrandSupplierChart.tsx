...
interface BrandSupplierChartProps {
  brandSupplierSeries: { name: string; data: Point[] }[];
}
...
function BrandSupplierChart({ brandSupplierSeries }: BrandSupplierChartProps) {
  return (
    <div>
      <h2 className="font-semibold mb-2 flex items-center">
        Prix moyen marque/fournisseur
        <InfoButton text="Compare les prix moyens par marque selon les fournisseurs." />
      </h2>
...
export default BrandSupplierChart;
