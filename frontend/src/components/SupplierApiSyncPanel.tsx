              ...
              {groupedRows.map(({ supplier_id, supplier, items, mapping }) => (
                ...
                >
                  <div className="px-5 py-4 flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <p className="text-sm text-[var(--color-text-muted)] uppercase tracking-wide">Fournisseur</p>
                      <h3 className="text-lg font-semibold text-[var(--color-text-heading)]">{supplier}</h3>
                    </div>
                    <div className="text-sm text-[var(--color-text-muted)] text-right space-y-1">
                      <p>
                    ...
                    {items.map((row, index) => (
                      ...
                      >
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-[var(--color-text-muted)] flex flex-wrap gap-3">
                            <span>EAN : {row.ean || '—'}</span>
                            <span>Part Number : {row.part_number || '—'}</span>
                            <span>SKU fournisseur : {row.supplier_sku || '—'}</span>
                          </div>
                        </div>
                        <div className="text-sm text-[var(--color-text-secondary)] text-right space-y-1 min-w-[120px]">
