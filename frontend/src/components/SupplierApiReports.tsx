...
function ReportList({
  ...
  return (
    <div className="p-5 rounded-md bg-[var(--color-bg-subtle)] border border-[var(--color-border-subtle)]">
        ...
        <ul className="space-y-3 max-h-80 overflow-y-auto pr-2">
          {items.map((item, index) => {
            ...
            return (
              <li
                key={key || `entry-${index}`}
                className="flex items-start justify-between gap-4 border border-[var(--color-border-subtle)] rounded-md px-3 py-2 bg-[var(--color-bg-faint)]"
              >
    ...
    <div className="p-5 rounded-md bg-[var(--color-bg-subtle)] border border-[var(--color-border-subtle)]">
      ...
      {entries.length === 0 ? (
        ...
        <div className="space-y-3">
          <pre className="text-xs text-left text-[var(--color-text-secondary)] bg-[var(--color-bg-subtle)] border border-[var(--color-border-subtle)] rounded-md p-4 overflow-x-auto whitespace-pre-wrap break-words max-h-80">
            {visibleEntries
        ...
        <div className="space-y-6">
          {reports.map((report) => {
            ...
            return (
              <div
                key={report.job_id}
                className="border border-[var(--color-border-subtle)] rounded-md bg-[var(--color-bg-subtle)] px-6 py-5"
              >
