...
Le framework `pytest` est configure dans le backend (SQLite in-memory, pas besoin de PostgreSQL) — 411 tests dans 16 fichiers :
...
Le framework `vitest` avec Testing Library est configure dans le frontend — 183 tests dans 18 fichiers :
